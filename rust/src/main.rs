...
const START_MESSAGE: &str = concat!(
    ...
    "<b>Орфография:</b>\n",
    "🪄 Проверка русскоязычных сообщений через YandexSpeller API. ",
    "Подсказки приходят одной строкой с обращением по имени ",
    "(видимость настраивается: public / private / off).\n\n",
    "<b>Как хранятся данные:</b>\n",
    "📦 Метаданные — в MySQL (тексты, имена, время, file_id).\n",
    "🗂 Сами файлы — на диске сервера в локальном хранилище ",
